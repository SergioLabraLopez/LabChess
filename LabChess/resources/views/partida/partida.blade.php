...
<body>
    ...
    <div class="container">
        ...
        <div id="themes">
            <button id="actualizar">Aztualizar</button>
            <button id="blancas">Negras</button>
            <button id="negras">Blancas</button>
            <button id="posiciones">Ver</button>
            <button id="clear">Limpiar</button>

            <div id="uci">
                <input type="text" id="uciMove" placeholder="e2e4" value="e2e4">
                <button id="moverUciButton">Mover</button>
            </div>
...
<script type="module" src="{{ asset('js/partida/partidaDom.js') }}"></script>
